...
INSERT INTO "new_Inventory" ("cellId", "comment", "deliveryDate", "desc", "id", "inboundDate", "lot", "materialId", "order", "quan_dev", "quan_ok", "stillageId", "storageId") SELECT "cellId", "comment", "deliveryDate", "desc", "id", "inboundDate", "lot", "materialId", "order", "quan_dev", "quan_ok", "stillageId", "storageId" FROM "Inventory";
